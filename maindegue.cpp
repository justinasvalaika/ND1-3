...
const int vektorius=1, listas=2, dekas=3;
...
deque<Sduomenys> lentele;
deque<Sduomenys> tinginiai;
deque<Sduomenys> grauzikai;
...
void nfaila()
{
        ...
        while (getline(is,lin))
    {
       ...
       /* if(Sd_temp1.galutinis<5)
        {
            tinginiai.push_back(Sd_temp1);
        }
        else
        {
            grauzikai.push_back(Sd_temp1);
        }*/
